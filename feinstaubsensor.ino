...
// Fingerprint for server, expires January 2021
const uint8_t fingerprint[20] = {0x4F, 0x02, 0x8E, 0x4B, 0x00, 0xC4, 0x05, 0x02, 0x85, 0x25, 0xC3, 0x86, 0xAD, 0x37, 0xBA, 0xD4, 0xE5, 0x18, 0x16, 0x8E};
